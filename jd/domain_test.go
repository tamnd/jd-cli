...
// HTTP behaviour is covered in jd_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "jd://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("jd", "about")
	if err != nil || got.String() != "jd://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want jd://page/about", got.String(), err)
	}
}
